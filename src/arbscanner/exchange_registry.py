...
EXCHANGE_VENUES: tuple[ExchangeVenue, ...] = (
    ExchangeVenue(
        ...
        recommended_permissions=("資産参照", "注文・約定履歴参照"),
    ...
    ExchangeVenue(
        ...
        recommended_permissions=("参照", "注文・約定履歴参照"),
        ip_allowlist_recommended=True,
        notes="公開板アダプターは実装済み。出金・振替権限は付与しません。",
    ),
    ExchangeVenue(
        id="bitflyer",
        ...
        recommended_permissions=("資産残高参照", "注文・約定履歴参照"),
        ip_allowlist_recommended=True,
        notes="現物BTC_JPYだけを対象とし、Crypto CFDは対象外です。",
    ),
    ExchangeVenue(
        id="coincheck",
        ...
        recommended_permissions=("残高参照", "注文・取引履歴参照"),
        ip_allowlist_recommended=True,
        notes="公開板アダプターは実装済み。出金・暗号資産送付APIは接続対象外です。",
    ),
    ExchangeVenue(
        id="bittrade",
        name="BitTrade",
        ...
        default_pair="btcjpy",
        api_docs_url="https://api-doc.bittrade.co.jp/",
        credential_env=("BITTRADE_API_KEY", "BITTRADE_API_SECRET"),
        key_issuance_note="BitTradeのWeb版API管理画面で発行し、最初は読取権限だけにします。",
        recommended_permissions=("読取", "取引（将来のみ）"),
        ip_allowlist_recommended=True,
        notes="REST/WebSocketと板・資産・注文APIを調査済み。次段の公開板候補です。",
    ),
    ExchangeVenue(
        id="okj",
        name="OKJ",
